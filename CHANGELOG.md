...
### Version 5.1.12 *(2026-05-11)*
This version of the BidMachine Adapter supports the following native SDK dependencies:
  * Android: `com.chartboost:chartboost-mediation-adapter-bidmachine:5.3.7.+`
  * iOS: `ChartboostMediationAdapterBidMachine: ~> 5.3.6.0`

### Version 5.1.11 *(2026-03-12)*
This version of the BidMachine Adapter supports the following native SDK dependencies:
  * Android: `com.chartboost:chartboost-mediation-adapter-bidmachine:5.3.6.+`
  * iOS: `ChartboostMediationAdapterBidMachine: ~> 5.3.6.0`

### Version 5.1.10 *(2026-03-12)*
This version of the BidMachine Adapter supports the following native SDK dependencies:
  * Android: `com.chartboost:chartboost-mediation-adapter-bidmachine:5.3.5.+`
  * iOS: `ChartboostMediationAdapterBidMachine: ~> 5.3.6.0`

### Version 5.1.9 *(2025-12-16)*
This version of the BidMachine Adapter supports the following native SDK dependencies:
  * Android: `com.chartboost:chartboost-mediation-adapter-bidmachine:5.3.5.+`
  * iOS: `ChartboostMediationAdapterBidMachine: ~> 5.3.5.0`
